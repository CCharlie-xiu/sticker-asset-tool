...
| **赞赏引导图** | 750×560，≤500KB | 选赞赏金额页用；浅灰底 + `cover`；JPG/PNG/GIF（动图仅首帧）；风格与表情一致、无无关内容由设计保证。 |
| **赞赏致谢图** | 750×750，≤500KB | 致谢页用；同上裁切与压缩策略。 |
...
| 路径 | 职责 |
|------|------|
| `js/rules/assetSpecsByMode.js` | 各素材的宽高、体积上限、透明/裁切策略；**加新模式主要改这里**。 |
